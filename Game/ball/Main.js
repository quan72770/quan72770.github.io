...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:40px;">欢迎!</span><br /><br /><span style="font-size:15px;"><strong>滚动小球玩法:</strong><br /><br />1. 随意拖动一个小球.<br />2.&nbsp;点击&nbsp;网页&nbsp;的&nbsp;背景.<br />3. 按住鼠标摇动.<br />4. 双击.<br />5.开始!</span>';
